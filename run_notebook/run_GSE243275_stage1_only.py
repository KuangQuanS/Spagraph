...
def main() -> None:
    dataset_dir = _REPO_ROOT / "spagraph_data" / "database" / "GSE243275"
    sc_file = dataset_dir / "GSM7782698_SC.h5ad"
    st_file = dataset_dir / "GSM7782699_ST.h5ad"
    output_dir = _REPO_ROOT / "spagraph_data" / "evaluate" / "GSE243275_stage1_only"
