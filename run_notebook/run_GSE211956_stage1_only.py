...
def main() -> None:
    sample = "P2"
    sc_file = _REPO_ROOT / "spagraph_data" / "database" / "GSE211956" / "GSE211956_SC.h5ad"
    st_file = _REPO_ROOT / "spagraph_data" / "database" / "GSE211956" / f"GSE211956_ST_{sample}.h5ad"
    output_dir = _REPO_ROOT / "spagraph_data" / "evaluate" / "GSE211956_stage1_only" / sample
