...
# 文件路径
# ------------------------------
cell_composition_csv = DATASET_DIR / "Spatial_composition.csv"
st_h5ad_path = REPO_ROOT / "spagraph_data" / "database" / "GSE144240" / "GSE144236_P2_ST.h5ad"
...
for col, ct in zip(cell_comp_cols, cell_types):
    ...
    sc.pl.spatial(
        ...
        cmap="viridis",
        vmin=0,
        vmax=vmax,  # 向下取整到一位小数；若过小则固定为 0.1
        title="",
        ax=ax,
        show=False,
